  ...
  return (
    <section className="help-page__section" id="dsr">
            ...
            [
              {
                ...
                bits: 32,
                description: "IP address of the node that initiated route discovery.",
              },
            ],
            [
              {
            ...
            [
              {
                label: "Address [1...n]",
                bits: 32,
                description: "List of intermediate addresses accumulating the route hop-by-hop.",
              },
            ],
          ]}
        />
          ...
          rows={[
            [
              ...
              },
              {
                label: "Identification",
                bits: 16,
                description: "Echoes the Identification from the corresponding RREQ.",
              },
            ],
            [
              {
                label: "Source Address",
                bits: 32,
                description: "IP address of the node generating this reply (original destination).",
              },
            ],
            [
              {
                ...
                bits: 32,
                description: "IP address of the original RREQ initiator.",
              },
            ],
            [
              {
                label: "Route [1...n]",
                bits: 32,
                description: "The complete source route from reply sender back to the initiator.",
              },
            ],
          ]}
        />
            ...
            [
              {
                ...
                bits: 32,
                description: "IP address of the node that detected the broken link.",
              },
            ],
            [
              {
                ...
                bits: 32,
                description: "IP address of the unreachable next hop that caused the error.",
              },
            ],
            [
              {
      ...
      <div className="help-page__chapter" id="route-cache">
        ...
        <TextBlock>
          Nodes dynamically populate their cache through active participation in Route Discovery:
        ...
        <TableBlock
          ...
          rows={[
            [
              ...
              "Tick when this route entry was last updated",
            ],
          ]}
        />

        <TextBlock>
          The simulator also maintains a **Request Table** to detect and suppress duplicate Route
          Requests. Each entry records the destination, the originating source, and the
          Identification value from the RREQ. When a node receives an RREQ whose (destination,
          source, identification) triple is already present, the request is discarded as a
          duplicate.
        </TextBlock>
        <TableBlock
          introText="Request Table Entry"
          ariaLabel="Request Table Entry"
          headers={["Destination", "Source", "Identification"]}
          rows={[
            [
              "Destination IP Address",
              "RREQ originator IP Address",
