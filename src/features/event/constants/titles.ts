...
const EVENT_TITLES = new Map<EventDetailsType, string>([
  ...
  [EventDetailsType.AodvRouteErrorProcessed, "AODV Route Error (Unicast)"],
  [EventDetailsType.AodvRouteErrorBroadcast, "AODV Route Error (Broadcast)"],
  ...
  [EventDetailsType.OlsrRouteAdded, "OLSR Record Added"],
  [EventDetailsType.OlsrRouteUpdated, "OLSR Record Updated"],
  [EventDetailsType.OlsrRouteRemoved, "OLSR Record Removed"],
  [EventDetailsType.OlsrRouteDropped, "OLSR Message Dropped"],
