export const messageCatalog = {
  en: {
    ...
    properties: {
      ...
      fieldDsdvIncrementalInterval: "Incremental Update Interval",
      fieldDsdvFullDumpInterval: "Full Dump Interval",
      fieldDsdvRouteTimeout: "Route Timeout",
      fieldAodvHelloInterval: "HELLO Interval",
      fieldAodvRouteTimeout: "Route Timeout",
      fieldOlsrHelloInterval: "HELLO Interval",
      fieldOlsrTcInterval: "TC Interval",
    ...
    runtime: {
      ...
      nextHopNoDsdv: "Selected next hop does not support DSDV",
      nextHopNoAodv: "Selected next hop does not support AODV",
      nextHopNoOlsr: "Selected next hop does not support OLSR",
      nextHopNoDsr: "Selected next hop does not support DSR",
      noRouteForDestinationDsdv: "No DSDV route is available for the destination",
      noRouteForDestinationAodv: "No AODV route is available for the destination",
      noRouteForDestinationOlsr: "No OLSR route is available for the destination",
      noRouteForDestinationDsr: "No DSR source route is available for the destination",
      sourcePeerNoProtocolModule: (protocol: string) =>
        `Source peer does not have a ${protocol} module`,
    ...
    simulation: {
      ...
      tableMetric: "Metric",
      tablePath: "Path",
      tablePrecursors: "Precursors",
      tableSequence: "Sequence Number",
      tableInstalled: "Last Update",
      tableLastSeen: "Last Seen",
      tableNoRecords: "No records",
      tableDsdvRoutes: "DSDV Routing Table",
      tableAodvRoutes: "AODV Routing Table",
      tableDsrRoutes: "DSR Route Cache",
      ...
      tableInspectionTitleDsdv: (nodeName: string) => `DSDV Structures on ${nodeName}`,
      tableInspectionTitleAodv: (nodeName: string) => `AODV Structures on ${nodeName}`,
      tableInspectionTitleDsr: (nodeName: string) => `DSR Structures on ${nodeName}`,
      tableInspectionTitleOlsr: (nodeName: string) => `OLSR Structures on ${nodeName}`,
      ...
      summaryOgm: "OGM",
      summaryDsdvFullDump: "DSDV Full Dump",
      summaryDsdvIncremental: "DSDV Incremental",
      summaryAodvRreq: "AODV RREQ",
      summaryAodvRrep: "AODV RREP",
      summaryAodvRerr: "AODV RERR",
      summaryAodvHello: "AODV HELLO",
      summaryOlsrHello: "OLSR HELLO",
      summaryOlsrTc: "OLSR TC",
      summaryAnsn: "ANSN",
      summaryEntries: "Entries",
      summaryPath: "Path",
      summaryRequestId: "Request ID",
      summaryBrokenLink: "Broken Link",
      summaryDsrRreq: "DSR RREQ",
      summaryDsrRrep: "DSR RREP",
      summaryDsrRerr: "DSR RERR",
      ogmBroadcastRetransmission: "OGMv2 Broadcast Retransmission",
      ogmBroadcast: "OGMv2 Broadcast",
      dsdvFullDumpBroadcast: "DSDV Full Dump Broadcast",
      dsdvIncrementalBroadcast: "DSDV Incremental Broadcast",
      aodvRreqBroadcast: "AODV Route Request Broadcast",
      aodvHelloBroadcast: "AODV HELLO Broadcast",
      olsrHelloBroadcast: "OLSR HELLO Broadcast",
      olsrTcBroadcast: "OLSR TC Broadcast",
      dsrRreqBroadcast: "DSR Route Request Broadcast",
      ...
      dsdvRouteAdded: "DSDV Route Added",
      dsdvRouteUpdated: "DSDV Route Updated",
      dsdvRouteRemoved: "DSDV Route Removed",
      aodvRouteAdded: "AODV Route Added",
      aodvRouteUpdated: "AODV Route Updated",
      aodvRouteRemoved: "AODV Route Removed",
      aodvRrepForwarded: "AODV Route Reply Forwarded",
      aodvRerrRaised: "AODV Route Error Raised",
      aodvControlProcessed: "AODV Control Processed",
      olsrRouteAdded: "OLSR Route Added",
      olsrRouteUpdated: "OLSR Route Updated",
      olsrRouteRemoved: "OLSR Route Removed",
      dsrRouteAdded: "DSR Route Cached",
      dsrRouteUpdated: "DSR Route Updated",
      dsrRouteRemoved: "DSR Route Removed",
      dsrRrepForwarded: "DSR Route Reply Forwarded",
      dsrRerrRaised: "DSR Route Error Raised",
      dsrControlProcessed: "DSR Control Processed",
      originatorRemoved: "Originator Removed",
      routeRemoved: "Route Removed",
      dsdvUpdateDropped: "DSDV Update Dropped",
      olsrRouteCalculation: "OLSR Route Calculation",
      ...
      eventRouteSelectedDsdv: (
        destinationLabel: string,
        nextHopLabel: string,
        metric: number,
        sequence: number,
      ) =>
        `Selected DSDV route to ${destinationLabel} via ${nextHopLabel} with metric ${metric} and sequence ${sequence}.`,
      eventRouteSelectedAodv: (
        destinationLabel: string,
        nextHopLabel: string,
        metric: number,
        sequence: number,
      ) =>
        `Selected AODV route to ${destinationLabel} via ${nextHopLabel} with hop count ${metric} and destination sequence ${sequence}.`,
      eventRouteSelectedOlsr: (destinationLabel: string, nextHopLabel: string, metric: number) =>
        `Selected OLSR route to ${destinationLabel} via ${nextHopLabel} with hop metric ${metric}.`,
      eventRouteSelectedDsr: (
        destinationLabel: string,
        nextHopLabel: string,
        metric: number,
        path: string,
      ) =>
        `Selected DSR source route to ${destinationLabel} via ${nextHopLabel} (${metric} hops). Full path: ${path}.`,
      ...
      aodvBroadcastBody: (note: string) => `Node processed AODV control traffic. ${note}`,
      dsrBroadcastBody: (note: string) => `Node flooded a DSR Route Request. ${note}`,
      ...
      dsdvRouteUpdateBody: (reason: string) =>
        `Node updated an existing DSDV route using the DSDV acceptance rule. ${reason}`,
      dsdvRouteRemoveBody: (reason: string) =>
        `Node removed a DSDV route after timeout-based garbage collection. ${reason}`,
      aodvRouteInsertBody: (reason: string) =>
        `Node inserted a new AODV route after route discovery or neighbour sensing. ${reason}`,
      aodvRouteUpdateBody: (reason: string) =>
        `Node updated an existing AODV route using sequence-number and hop-count comparison. ${reason}`,
      aodvRouteRemoveBody: (reason: string) =>
        `Node removed or invalidated an AODV route after timeout or link-break processing. ${reason}`,
      dsrRouteInsertBody: (reason: string) =>
        `Node inserted a DSR Route Cache entry from a discovered source route. ${reason}`,
      dsrRouteUpdateBody: (reason: string) =>
        `Node updated a DSR Route Cache entry after receiving fresher route knowledge. ${reason}`,
      dsrRouteRemoveBody: (reason: string) =>
        `Node removed a DSR Route Cache entry after link failure or expiration. ${reason}`,
    ...
    packet: {
      ...
      dsdvStructureAria: "DSDV route update structure",
      aodvRreqStructureAria: "AODV Route Request structure",
      aodvRrepStructureAria: "AODV Route Reply structure",
      aodvRerrStructureAria: "AODV Route Error structure",
      aodvHelloStructureAria: "AODV HELLO structure",
      olsrHelloStructureAria: "OLSR HELLO message structure",
      olsrTcStructureAria: "OLSR TC message structure",
      dsrRreqStructureAria: "DSR Route Request message structure",
      dsrRrepStructureAria: "DSR Route Reply message structure",
      dsrRerrStructureAria: "DSR Route Error message structure",
      bitsSuffix: "bits",
      ...
      fieldPrefixSize: "Prefix Size",
      fieldDestinationSequenceNumber: "Destination Sequence Number",
      fieldRreqId: "RREQ ID",
      fieldDestCount: "Dest Count",
      ...
      fieldOptDataLen: "Opt Data Len",
      fieldIdentification: "Identification",
      fieldTargetAddress: "Target Address",
      fieldAddressList: "Address [1...n]",
      fieldErrorType: "Error Type",
      fieldSalvage: "Salvage",
      fieldErrorSourceAddress: "Error Source Address",
      fieldErrorDestinationAddress: "Error Destination Address",
      fieldTypeSpecificInformation: "Type-Specific Information",
      notAvailable: "N/A",
      dsdvTitle: "DSDV Update Message",
      aodvRreqTitle: "AODV Route Request (RREQ)",
      aodvRrepTitle: "AODV Route Reply (RREP)",
      aodvRerrTitle: "AODV Route Error (RERR)",
      aodvHelloTitle: "AODV HELLO Message",
      olsrHelloTitle: "OLSR HELLO Message",
      olsrTcTitle: "OLSR TC Message",
      dsrRreqTitle: "DSR Route Request (RREQ)",
      dsrRrepTitle: "DSR Route Reply (RREP)",
      dsrRerrTitle: "DSR Route Error (RERR)",
    },
    refreshStep: {
      elpTitle: (peerName: string) => `ELP Refresh on ${peerName}`,
      ogmTitle: (peerName: string) => `OGM Broadcast on ${peerName}`,
      dsdvFullDumpTitle: (peerName: string) => `DSDV Full Dump on ${peerName}`,
      dsdvIncrementalTitle: (peerName: string) => `DSDV Incremental Update on ${peerName}`,
      aodvHelloTitle: (peerName: string) => `AODV HELLO on ${peerName}`,
      olsrHelloTitle: (peerName: string) => `OLSR HELLO on ${peerName}`,
      olsrTcTitle: (peerName: string) => `OLSR TC on ${peerName}`,
    },
  },
} as const;
